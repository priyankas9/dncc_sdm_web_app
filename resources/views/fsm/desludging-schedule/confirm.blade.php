    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
         <div class="modal-header bg-info text-white">
            ...
            @csrf
                <div class="modal-body" id="emptyingForm" >
                        <input type="hidden" id="binId_confirm" name="bin">
                        ...
                        <div class="col-sm-8">
                            {!! Form::text('proposed_emptying_date', null, ['class' => 'form-control', 'placeholder' => 'Proposed Emptying Date', 'id' => 'proposed_emptying_date','readOnly']) !!}
                        </div>
                        </div>
                </div>
